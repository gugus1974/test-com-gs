...
/**********************************************************/
int shf0(unsigned int xhuge * startadd, unsigned int xhuge * endadd)
{
...
/*   endadd      indirizzo di fine della ram              */
/**********************************************************/
int shf1(unsigned int xhuge * startadd, unsigned int xhuge * endadd)
{
	unsigned int data3,vrf,tim1,i,k,dt;
	int  er;
	unsigned int xhuge * pt_ram;
...
/*   endadd      indirizzo di fine della ram              */
/**********************************************************/
int march(unsigned int xhuge * startadd, unsigned int xhuge * endadd)
{
...
/*   endadd      indirizzo di fine della ram              */
/**********************************************************/
int maxrum(unsigned int xhuge * startadd, unsigned int xhuge * endadd)
{
	unsigned int data3,vrf,tim1,i,k,dt;
	int  er;
	unsigned int xhuge * pt_ram;
...
/*   endadd      indirizzo di fine della ram              */
/**********************************************************/
int shf0_mvb(unsigned int xhuge * startadd, unsigned int xhuge * endadd)
{
...
/*   endadd      indirizzo di fine della ram              */
/**********************************************************/
int shf1_mvb(unsigned int xhuge * startadd, unsigned int xhuge * endadd)
{
	unsigned int data3,tim1,i,k,dt,vrf;
	int  er;
	unsigned int xhuge * pt_ram;
...
/*   endadd      indirizzo di fine della ram              */
/**********************************************************/
int march_mvb(unsigned int xhuge * startadd, unsigned int xhuge * endadd)
{
	unsigned int data3,tim1,i,k,dt,j,vrf;
	int  er;
	unsigned int xhuge * pt_ram;
...
/*   endadd      indirizzo di fine della ram              */
/**********************************************************/
int maxrum_mvb(unsigned int xhuge * startadd, unsigned int xhuge * endadd)
{
	unsigned int data3,tim1,i,k,dt,vrf;
	int  er;
	unsigned int xhuge * pt_ram;
	unsigned int xhuge * pt_ram1;
	unsigned int  off,seg;
	unsigned long app; 
	char c;
...
int t_mvbel (void)
{
	...
	*regivr0 = 0;
	*regivr1 = 0;
        st_DA_PITptr = (unsigned int xhuge *)(st_DA_PIT + data1*2);
...
/*                   
saddmvb = (unsigned int xhuge *)0x203f80;
