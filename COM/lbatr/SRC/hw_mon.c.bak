...
/*---------------------------------------------------------------------------------------------*/
static short flash_chiperase(short argc, char *argv[])
{
	if (argc != 1) return -1;

	if (am29f040_chip_erase(0x400000) == AM29F040_OK)
...
/* ****************************************************************************
    $Log: hw_mon.c,v $
    Revision 1.1.2.3  2006/12/05 14:02:11  schiavor
