...
static void uartU30_init (unsigned char ) ;
...
//	uartU27 = UART8251_U27_CTRL_ADDR; 
	...
	uartU27[1] = BIN8(
				...
				1	,//b2 -	  1	 1 -> 8 bit data
				1	,//b1 -  b2 b1
				0    );	 // 1  0 -> x16  (default per scheda DG630-29)
				         // 1  1 -> x64  (default per scheda DG630-48) */
...
static void uartU30_init (unsigned char tipo_scheda)
{
	...
	uartU30[1] = BIN8(
				...
				1	,//b2 -	  1	 1 -> 8 bit data
				1	,//b1 -  b2 b1
				     /*b0 -	  1  0 -> x16  (default per scheda DG630-29)
				              1  1 -> x64  (default per scheda DG630-48) */
				(tipo_scheda==2));
