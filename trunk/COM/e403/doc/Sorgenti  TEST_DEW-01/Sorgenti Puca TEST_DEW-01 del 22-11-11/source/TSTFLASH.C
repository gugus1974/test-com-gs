	    ...
	    {		
		    ...
		    while( (((data3 = *pt_flash)  & dt) == 0) && ((c=_getkey())  != '\r') ) {
		        ...
		        {	   
        			...
        			app = app >> 16;
        			seg = (unsigned int)(app & 0x0000FF);
        			printf("\r1-KO!!! Ad Address %02x%04x Bit %02d atteso 1 letto 0",seg,off, j);
        			k = 0;
        			tim1 = 1;
        			er = 10;
    	        }
    		...
    		*pt_flash = data2;
    		...
    		while( (((data3 = *pt_flash)  & dt) != 0) && ((c = _getkey())  != '\r') ) {    
		        ...
		        {	   
        			...
        			app = app >> 16;
        			seg = (unsigned int)(app & 0x0000FF);
        			printf("\r2-KO!!! Ad Address %02x%04x Bit %02d atteso 0 letto 1",seg,off, j);
        			k = 0;
        			tim1 = 1;
        			er = 13;
        	    }
         ...
         printf("p @%04l %04l   %04l\n", pt_flash, (* pt_flash),data2);
