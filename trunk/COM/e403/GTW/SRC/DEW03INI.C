...
unsigned int  * sctstr    = (unsigned int  *)0x800000;   /*  limite inferiore indirizzi settore (unsigned int  *)0x400000; */
...
unsigned int  * flashlimit = (unsigned int  *)0xFFFFFE;  /*  limite superiore indirizzi (unsigned int  *)0xBFFFFE; */
