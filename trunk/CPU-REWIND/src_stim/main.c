...
void menu (void)
{
	...
	do
    {
		...
		printf("	 6 - test UART_U30 DG630-29(prescaler x16)\n");
		printf("	 7 - test UART_U30 DG630-12(prescaler x64)\n\n");
	    printf ("\n\n     Scelta test: ");
	    //scanf ("%d", &scelta_test);
		c = _getkey();
		...
		if(scelta_test>0 && scelta_test<7)
		    exit_menu=1;
		else 
			exit_menu=0;
...
/**
		...
		switch (scelta_test)
		{
		 ...
		 case 5: 	test_uartU27_trasmetti();
		 			break;
		 case 6: 	test_uartU30(1);//scheda CPU DGS-29
		 			break;
		 case 7: 	test_uartU30(2);//scheda CPU DGS-48
		 			break;
